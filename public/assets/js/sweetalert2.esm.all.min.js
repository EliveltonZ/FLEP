...
const He = (e) => {
  ...
  et = (e, t, n) => {
    g(t.allowEscapeKey) && (e.preventDefault(), n(ze.esc));
  };
var tt = {
...
const mn = (e) => {
  ...
  hn = (e, t, n) => {
    t.container.onclick = (o) => {
      pn
        ? (pn = !1)
        : o.target === t.container && g(e.allowOutsideClick) && n(ze.backdrop);
    };
  },
  fn = (e) =>
...
class Un {
  ...
  _main(e, t = {}) {
    ...
    const i = Kn(Fn);
    return Re(Fn, n), ge.innerParams.set(Fn, n), zn(Fn, i, n);
  }
  then(e) {

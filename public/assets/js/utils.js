  ...
  static insertDeleteButtonCell(_class) {
    return `
        <button class="btn btn-danger ${_class}" type="button" style="padding:0;margin-left:10px;">
          <svg class="function d-flex d-xxl-flex justify-content-center justify-content-xxl-center" xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 20 20" fill="none" style="color:#fff;height:100%;width:100%;">
